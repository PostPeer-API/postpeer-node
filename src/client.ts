...
import { Health, HealthCheckResponse, HealthVerifyAccessKeyResponse } from './resources/health';
...
export class Postpeer {
  ...
  protected async authHeaders(opts: FinalRequestOptions): Promise<NullableHeaders | undefined> {
    return buildHeaders([{ 'x-access-key': this.apiKey }]);
  }
  ...
  platforms: API.Platforms = new API.Platforms(this);
