...
export const parseClientAuthHeaders = (req: IncomingMessage, required?: boolean): Partial<ClientOptions> => { const apiKey = Array.isArray(req.headers['x-access-key']) ? req.headers['x-access-key'][0] : req.headers['x-access-key']
return {apiKey}; }
