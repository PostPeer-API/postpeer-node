...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ integrations: { id: string; createdAt: string; displayName: string; imageUrl: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; platformUserId: string; profileId: string; }[]; limit: number; page: number; success: boolean; total: number; }",
    markdown:
      "## list\n\n`client.connect.integrations.list(limit?: number, page?: number, platform?: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook', profileId?: string): { integrations: object[]; limit: number; page: number; success: boolean; total: number; }`\n\n**get** `/v1/connect/integrations`\n\nList integrations connected to this project\n\n### Parameters\n\n- `limit?: number`\n  Page size (1-100)\n\n- `page?: number`\n  Page number\n\n- `platform?: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'`\n\n- `profileId?: string`\n  Filter to integrations belonging to this profile. Pass \"null\" (literal string) to filter to integrations with no profile.\n\n### Returns\n\n- `{ integrations: { id: string; createdAt: string; displayName: string; imageUrl: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; platformUserId: string; profileId: string; }[]; limit: number; page: number; success: boolean; total: number; }`\n\n  - `integrations: { id: string; createdAt: string; displayName: string; imageUrl: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; platformUserId: string; profileId: string; }[]`\n  - `limit: number`\n  - `page: number`\n  - `success: boolean`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst integrations = await client.connect.integrations.list();\n\nconsole.log(integrations);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ platforms: { name: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; status: 'prod' | 'beta' | 'dev'; }[]; }",
    markdown:
  ...
  },
  {
    ...
    params: [
      'content: string;',
      "platforms: { accountId: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; platformSpecificData?: object; }[];",
  ...
  },
  {
    ...
    response:
      "{ posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]; success: boolean; total: number; }",
    markdown:
      "## list\n\n`client.posts.list(createdAfter?: string, createdBefore?: string, limit?: number, offset?: number, platform?: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'[], scheduledAfter?: string, scheduledBefore?: string, sort?: 'asc' | 'desc', status?: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'): { posts: object[]; success: boolean; total: number; }`\n\n**get** `/v1/posts/`\n\nReturns a paginated list of posts. Filter by status, platform (OR logic), and date ranges. Published posts include platformPostUrl per platform.\n\n### Parameters\n\n- `createdAfter?: string`\n  ISO 8601 lower bound on createdAt\n\n- `createdBefore?: string`\n  ISO 8601 upper bound on createdAt\n\n- `limit?: number`\n  Page size (max 100)\n\n- `offset?: number`\n  Number of posts to skip\n\n- `platform?: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'[]`\n  Filter by platform (repeatable — OR logic)\n\n- `scheduledAfter?: string`\n  ISO 8601 lower bound on scheduledFor\n\n- `scheduledBefore?: string`\n  ISO 8601 upper bound on scheduledFor\n\n- `sort?: 'asc' | 'desc'`\n\n- `status?: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'`\n\n### Returns\n\n- `{ posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]; success: boolean; total: number; }`\n\n  - `posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]`\n  - `success: boolean`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst posts = await client.posts.list();\n\nconsole.log(posts);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ post: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }; success: boolean; }",
    markdown:
  ...
  },
  {
    ...
    response:
      "{ posts: { content: string; createdAt: string; platforms: { platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; scheduledFor: string; timezone: string; mediaItems?: { type: 'image' | 'video' | 'gif'; url: string; thumbnail?: string; }[]; }[]; success: boolean; }",
    markdown:
      "## list\n\n`client.posts.scheduled.list(): { posts: object[]; success: boolean; }`\n\n**get** `/v1/posts/scheduled/`\n\nList all scheduled posts\n\n### Returns\n\n- `{ posts: { content: string; createdAt: string; platforms: { platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; scheduledFor: string; timezone: string; mediaItems?: { type: 'image' | 'video' | 'gif'; url: string; thumbnail?: string; }[]; }[]; success: boolean; }`\n\n  - `posts: { content: string; createdAt: string; platforms: { platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky' | 'facebook'; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; scheduledFor: string; timezone: string; mediaItems?: { type: 'image' | 'video' | 'gif'; url: string; thumbnail?: string; }[]; }[]`\n  - `success: boolean`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst scheduleds = await client.posts.scheduled.list();\n\nconsole.log(scheduleds);\n```",
    perLanguage: {
      typescript: {
