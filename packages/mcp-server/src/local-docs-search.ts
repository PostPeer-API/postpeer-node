...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    "response": "{ posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: object[]; platforms: object[]; postId: string; rawRequestBody: object; scheduledFor: string; status: status; timezone: string; updatedAt: string; }[]; success: boolean; total: number; }",
  ...
  },
  {
    ...
    "response": "{ post: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: object[]; platforms: object[]; postId: string; rawRequestBody: object; scheduledFor: string; status: status; timezone: string; updatedAt: string; }; success: boolean; }",
  ...
  },
  {
    ...
    "response": "{ posts: { content: string; createdAt: string; platforms: { platform: string; status: string; }[]; postId: string; scheduledFor: string; timezone: string; mediaItems?: { type: 'image' | 'video' | 'gif'; url: string; thumbnail?: string; }[]; }[]; success: boolean; }",
