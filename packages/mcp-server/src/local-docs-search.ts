...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      'content: string;',
      'platforms: { accountId: string; platform: string; platformSpecificData?: object; }[];',
  ...
  },
  {
    ...
    response:
      "{ posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]; success: boolean; total: number; }",
    markdown:
      "## list\n\n`client.posts.list(createdAfter?: string, createdBefore?: string, limit?: number, offset?: number, platform?: string[], profileId?: string, scheduledAfter?: string, scheduledBefore?: string, sort?: 'asc' | 'desc', status?: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'): { posts: object[]; success: boolean; total: number; }`\n\n**get** `/v1/posts/`\n\nReturns a paginated list of posts. Filter by status, platform (OR logic), and date ranges. Published posts include platformPostUrl per platform.\n\n### Parameters\n\n- `createdAfter?: string`\n  ISO 8601 lower bound on createdAt\n\n- `createdBefore?: string`\n  ISO 8601 upper bound on createdAt\n\n- `limit?: number`\n  Page size (max 100)\n\n- `offset?: number`\n  Number of posts to skip\n\n- `platform?: string[]`\n  Filter by platform (repeatable — OR logic)\n\n- `profileId?: string`\n  Filter to posts targeting an integration bound to this profile. Pass \"null\" (literal string) to filter to posts whose integrations have no profile.\n\n- `scheduledAfter?: string`\n  ISO 8601 lower bound on scheduledFor\n\n- `scheduledBefore?: string`\n  ISO 8601 upper bound on scheduledFor\n\n- `sort?: 'asc' | 'desc'`\n\n- `status?: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'`\n\n### Returns\n\n- `{ posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]; success: boolean; total: number; }`\n\n  - `posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]`\n  - `success: boolean`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst posts = await client.posts.list();\n\nconsole.log(posts);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ post: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }; success: boolean; }",
    markdown:
      "## retrieve\n\n`client.posts.retrieve(postId: string): { post: object; success: boolean; }`\n\n**get** `/v1/posts/{postId}`\n\nGet a single post by ID\n\n### Parameters\n\n- `postId: string`\n\n### Returns\n\n- `{ post: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }; success: boolean; }`\n\n  - `post: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }`\n  - `success: boolean`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst post = await client.posts.retrieve('postId');\n\nconsole.log(post);\n```",
    perLanguage: {
      typescript: {
