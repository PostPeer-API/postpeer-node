...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      'content: string;',
      'platforms: { accountId: string; platform: string; content?: string; platformSpecificData?: object; }[];',
