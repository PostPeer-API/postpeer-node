...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    stainlessPath: '(resource) posts > (method) retrieve_',
    qualified: 'client.posts.retrieve',
    params: [
      'createdAfter?: string;',
    ...
    perLanguage: {
      ...
      python: {
        method: 'posts.retrieve',
        example:
          'import os\nfrom postpeer import Postpeer\n\nclient = Postpeer(\n    api_key=os.environ.get("POSTPEER_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.posts.retrieve()\nprint(response.posts)',
      },
      typescript: {
        method: 'client.posts.retrieve',
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) posts.scheduled > (method) retrieve_',
    qualified: 'client.posts.scheduled.retrieve',
    response:
    ...
    perLanguage: {
      ...
      python: {
        method: 'posts.scheduled.retrieve',
        example:
          'import os\nfrom postpeer import Postpeer\n\nclient = Postpeer(\n    api_key=os.environ.get("POSTPEER_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.posts.scheduled.retrieve()\nprint(response.posts)',
      },
      typescript: {
        method: 'client.posts.scheduled.retrieve',
        example:
          "import Postpeer from 'postpeer';\n\nconst client = new Postpeer({\n  apiKey: process.env['POSTPEER_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.posts.scheduled.retrieve();\n\nconsole.log(response.posts);",
      },
    },
