...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ integrations: { id: string; app: { id?: string; imageUrl?: string; name?: string; }; appId: string; byok: boolean; createdAt: string; displayName: string; imageUrl: string; platform: string; platformUserId: string; profileId: string; profileUrl: string; username: string; platformMetadata?: object; }[]; success: boolean; total: number; }',
    markdown:
      "## list\n\n`client.connect.integrations.list(limit?: number, offset?: number, platform?: string, profileId?: string, q?: string, sort?: 'asc' | 'desc'): { integrations: object[]; success: boolean; total: number; }`\n\n**get** `/v1/connect/integrations`\n\nList integrations connected to this project\n\n### Parameters\n\n- `limit?: number`\n  Page size (max 100)\n\n- `offset?: number`\n  Number of integrations to skip\n\n- `platform?: string`\n\n- `profileId?: string`\n  Filter to integrations belonging to this profile. Pass \"null\" (literal string) to filter to integrations with no profile.\n\n- `q?: string`\n  Case-insensitive search across the connected account name (displayName), username, and platform user ID.\n\n- `sort?: 'asc' | 'desc'`\n\n### Returns\n\n- `{ integrations: { id: string; app: { id?: string; imageUrl?: string; name?: string; }; appId: string; byok: boolean; createdAt: string; displayName: string; imageUrl: string; platform: string; platformUserId: string; profileId: string; profileUrl: string; username: string; platformMetadata?: object; }[]; success: boolean; total: number; }`\n\n  - `integrations: { id: string; app: { id?: string; imageUrl?: string; name?: string; }; appId: string; byok: boolean; createdAt: string; displayName: string; imageUrl: string; platform: string; platformUserId: string; profileId: string; profileUrl: string; username: string; platformMetadata?: object; }[]`\n  - `success: boolean`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst integrations = await client.connect.integrations.list();\n\nconsole.log(integrations);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      'content: string;',
      "platforms: { accountId: string; platform: 'twitter'; content?: string; platformSpecificData?: { communityId?: string; poll?: { durationMinutes: number; options: string[]; }; replySettings?: 'following' | 'mentionedUsers' | 'subscribers' | 'verified'; replyToTweetId?: string; shareWithFollowers?: boolean; threadItems?: { content: string; mediaItems?: { type: 'image' | 'video' | 'gif' | 'document'; url: string; thumbnail?: string; }[]; }[]; }; } | { accountId: string; platform: 'instagram'; content?: string; platformSpecificData?: { coverUrl?: string; shareToFeed?: boolean; thumbOffset?: number; }; } | { accountId: string; platform: 'youtube'; content?: string; platformSpecificData?: { categoryId?: string; containsSyntheticMedia?: boolean; firstComment?: string; madeForKids?: boolean; tags?: string[]; title?: string; visibility?: 'public' | 'private' | 'unlisted'; }; } | { accountId: string; platform: 'tiktok'; content?: string; platformSpecificData?: { autoAddMusic?: boolean; brandContentToggle?: boolean; brandOrganicToggle?: boolean; disableComment?: boolean; disableDuet?: boolean; disableStitch?: boolean; draft?: boolean; isAigc?: boolean; photoCoverIndex?: number; privacyLevel?: 'PUBLIC_TO_EVERYONE' | 'MUTUAL_FOLLOW_FRIENDS' | 'FOLLOWER_OF_CREATOR' | 'SELF_ONLY'; videoCoverTimestampMs?: number; }; } | { accountId: string; platform: 'pinterest'; content?: string; platformSpecificData?: { boardId: string; altText?: string; coverImageUrl?: string; dominantColor?: string; link?: string; title?: string; }; } | { accountId: string; platform: 'linkedin'; content?: string; platformSpecificData?: { articleDescription?: string; articleTitle?: string; articleUrl?: string; documentTitle?: string; visibility?: 'PUBLIC' | 'CONNECTIONS'; }; } | { accountId: string; platform: 'bluesky'; content?: string; platformSpecificData?: { altText?: string[]; langs?: string[]; }; } | { accountId: string; platform: 'facebook'; content?: string; platformSpecificData?: { link?: string; published?: boolean; videoThumbnailUrl?: string; }; } | { accountId: string; platform: 'threads'; content?: string; platformSpecificData?: { altText?: string[]; replyControl?: 'everyone' | 'accounts_you_follow' | 'mentioned_only'; }; } | { accountId: string; platform: 'googlebusiness'; content?: string; platformSpecificData?: { callToActionType?: 'BOOK' | 'ORDER' | 'SHOP' | 'LEARN_MORE' | 'SIGN_UP' | 'CALL' | 'GET_OFFER'; callToActionUrl?: string; eventEndDate?: string; eventEndTime?: string; eventStartDate?: string; eventStartTime?: string; eventTitle?: string; offerCouponCode?: string; offerRedeemOnlineUrl?: string; offerTermsConditions?: string; topicType?: 'STANDARD' | 'EVENT' | 'OFFER'; }; }[];",
      "mediaItems?: { type: 'image' | 'video' | 'gif' | 'document'; url: string; thumbnail?: string; }[];",
      'publishNow?: boolean;',
      'scheduledFor?: string;',
      'timezone?: string;',
    ],
    response:
      "{ platforms: { platform: string; success: boolean; error?: string; platformPostUrl?: string; warningMessage?: string; }[]; postId: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; success: boolean; scheduledFor?: string; }",
    markdown:
      "## create\n\n`client.posts.create(content: string, platforms: { accountId: string; platform: 'twitter'; content?: string; platformSpecificData?: { communityId?: string; poll?: object; replySettings?: 'following' | 'mentionedUsers' | 'subscribers' | 'verified'; replyToTweetId?: string; shareWithFollowers?: boolean; threadItems?: object[]; }; } | { accountId: string; platform: 'instagram'; content?: string; platformSpecificData?: { coverUrl?: string; shareToFeed?: boolean; thumbOffset?: number; }; } | { accountId: string; platform: 'youtube'; content?: string; platformSpecificData?: { categoryId?: string; containsSyntheticMedia?: boolean; firstComment?: string; madeForKids?: boolean; tags?: string[]; title?: string; visibility?: 'public' | 'private' | 'unlisted'; }; } | { accountId: string; platform: 'tiktok'; content?: string; platformSpecificData?: { autoAddMusic?: boolean; brandContentToggle?: boolean; brandOrganicToggle?: boolean; disableComment?: boolean; disableDuet?: boolean; disableStitch?: boolean; draft?: boolean; isAigc?: boolean; photoCoverIndex?: number; privacyLevel?: 'PUBLIC_TO_EVERYONE' | 'MUTUAL_FOLLOW_FRIENDS' | 'FOLLOWER_OF_CREATOR' | 'SELF_ONLY'; videoCoverTimestampMs?: number; }; } | { accountId: string; platform: 'pinterest'; content?: string; platformSpecificData?: { boardId: string; altText?: string; coverImageUrl?: string; dominantColor?: string; link?: string; title?: string; }; } | { accountId: string; platform: 'linkedin'; content?: string; platformSpecificData?: { articleDescription?: string; articleTitle?: string; articleUrl?: string; documentTitle?: string; visibility?: 'PUBLIC' | 'CONNECTIONS'; }; } | { accountId: string; platform: 'bluesky'; content?: string; platformSpecificData?: { altText?: string[]; langs?: string[]; }; } | { accountId: string; platform: 'facebook'; content?: string; platformSpecificData?: { link?: string; published?: boolean; videoThumbnailUrl?: string; }; } | { accountId: string; platform: 'threads'; content?: string; platformSpecificData?: { altText?: string[]; replyControl?: 'everyone' | 'accounts_you_follow' | 'mentioned_only'; }; } | { accountId: string; platform: 'googlebusiness'; content?: string; platformSpecificData?: { callToActionType?: 'BOOK' | 'ORDER' | 'SHOP' | 'LEARN_MORE' | 'SIGN_UP' | 'CALL' | 'GET_OFFER'; callToActionUrl?: string; eventEndDate?: string; eventEndTime?: string; eventStartDate?: string; eventStartTime?: string; eventTitle?: string; offerCouponCode?: string; offerRedeemOnlineUrl?: string; offerTermsConditions?: string; topicType?: 'STANDARD' | 'EVENT' | 'OFFER'; }; }[], mediaItems?: { type: 'image' | 'video' | 'gif' | 'document'; url: string; thumbnail?: string; }[], publishNow?: boolean, scheduledFor?: string, timezone?: string): { platforms: object[]; postId: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; success: boolean; scheduledFor?: string; }`\n\n**post** `/v1/posts/`\n\nPublish a post to one or more social media platforms\n\n### Parameters\n\n- `content: string`\n  Post text body\n\n- `platforms: { accountId: string; platform: 'twitter'; content?: string; platformSpecificData?: { communityId?: string; poll?: { durationMinutes: number; options: string[]; }; replySettings?: 'following' | 'mentionedUsers' | 'subscribers' | 'verified'; replyToTweetId?: string; shareWithFollowers?: boolean; threadItems?: { content: string; mediaItems?: { type: 'image' | 'video' | 'gif' | 'document'; url: string; thumbnail?: string; }[]; }[]; }; } | { accountId: string; platform: 'instagram'; content?: string; platformSpecificData?: { coverUrl?: string; shareToFeed?: boolean; thumbOffset?: number; }; } | { accountId: string; platform: 'youtube'; content?: string; platformSpecificData?: { categoryId?: string; containsSyntheticMedia?: boolean; firstComment?: string; madeForKids?: boolean; tags?: string[]; title?: string; visibility?: 'public' | 'private' | 'unlisted'; }; } | { accountId: string; platform: 'tiktok'; content?: string; platformSpecificData?: { autoAddMusic?: boolean; brandContentToggle?: boolean; brandOrganicToggle?: boolean; disableComment?: boolean; disableDuet?: boolean; disableStitch?: boolean; draft?: boolean; isAigc?: boolean; photoCoverIndex?: number; privacyLevel?: 'PUBLIC_TO_EVERYONE' | 'MUTUAL_FOLLOW_FRIENDS' | 'FOLLOWER_OF_CREATOR' | 'SELF_ONLY'; videoCoverTimestampMs?: number; }; } | { accountId: string; platform: 'pinterest'; content?: string; platformSpecificData?: { boardId: string; altText?: string; coverImageUrl?: string; dominantColor?: string; link?: string; title?: string; }; } | { accountId: string; platform: 'linkedin'; content?: string; platformSpecificData?: { articleDescription?: string; articleTitle?: string; articleUrl?: string; documentTitle?: string; visibility?: 'PUBLIC' | 'CONNECTIONS'; }; } | { accountId: string; platform: 'bluesky'; content?: string; platformSpecificData?: { altText?: string[]; langs?: string[]; }; } | { accountId: string; platform: 'facebook'; content?: string; platformSpecificData?: { link?: string; published?: boolean; videoThumbnailUrl?: string; }; } | { accountId: string; platform: 'threads'; content?: string; platformSpecificData?: { altText?: string[]; replyControl?: 'everyone' | 'accounts_you_follow' | 'mentioned_only'; }; } | { accountId: string; platform: 'googlebusiness'; content?: string; platformSpecificData?: { callToActionType?: 'BOOK' | 'ORDER' | 'SHOP' | 'LEARN_MORE' | 'SIGN_UP' | 'CALL' | 'GET_OFFER'; callToActionUrl?: string; eventEndDate?: string; eventEndTime?: string; eventStartDate?: string; eventStartTime?: string; eventTitle?: string; offerCouponCode?: string; offerRedeemOnlineUrl?: string; offerTermsConditions?: string; topicType?: 'STANDARD' | 'EVENT' | 'OFFER'; }; }[]`\n  Target platform accounts to publish to\n\n- `mediaItems?: { type: 'image' | 'video' | 'gif' | 'document'; url: string; thumbnail?: string; }[]`\n  Media attachments (images, videos, GIFs)\n\n- `publishNow?: boolean`\n  Publish immediately. Required when scheduledFor is omitted.\n\n- `scheduledFor?: string`\n  ISO 8601 datetime to schedule the post for future publishing\n\n- `timezone?: string`\n  IANA timezone for the scheduled time (e.g. America/New_York). Defaults to UTC.\n\n### Returns\n\n- `{ platforms: { platform: string; success: boolean; error?: string; platformPostUrl?: string; warningMessage?: string; }[]; postId: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; success: boolean; scheduledFor?: string; }`\n\n  - `platforms: { platform: string; success: boolean; error?: string; platformPostUrl?: string; warningMessage?: string; }[]`\n  - `postId: string`\n  - `status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'`\n  - `success: boolean`\n  - `scheduledFor?: string`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst post = await client.posts.create({ content: 'Hello world!', platforms: [{ accountId: '<your-account-id>', platform: 'twitter' }] });\n\nconsole.log(post);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { content: string; errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]; success: boolean; total: number; }",
    markdown:
      "## list\n\n`client.posts.list(createdAfter?: string, createdBefore?: string, limit?: number, offset?: number, platform?: string[], profileId?: string, scheduledAfter?: string, scheduledBefore?: string, sort?: 'asc' | 'desc', status?: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'): { posts: object[]; success: boolean; total: number; }`\n\n**get** `/v1/posts/`\n\nReturns a paginated list of posts. Filter by status, platform (OR logic), and date ranges. Published posts include platformPostUrl per platform.\n\n### Parameters\n\n- `createdAfter?: string`\n  ISO 8601 lower bound on createdAt\n\n- `createdBefore?: string`\n  ISO 8601 upper bound on createdAt\n\n- `limit?: number`\n  Page size (max 100)\n\n- `offset?: number`\n  Number of posts to skip\n\n- `platform?: string[]`\n  Filter by platform (repeatable — OR logic)\n\n- `profileId?: string`\n  Filter to posts targeting an integration bound to this profile. Pass \"null\" (literal string) to filter to posts whose integrations have no profile.\n\n- `scheduledAfter?: string`\n  ISO 8601 lower bound on scheduledFor\n\n- `scheduledBefore?: string`\n  ISO 8601 upper bound on scheduledFor\n\n- `sort?: 'asc' | 'desc'`\n\n- `status?: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'`\n\n### Returns\n\n- `{ posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { content: string; errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]; success: boolean; total: number; }`\n\n  - `posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { content: string; errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]`\n  - `success: boolean`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst posts = await client.posts.list();\n\nconsole.log(posts);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ post: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { content: string; errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }; success: boolean; }",
    markdown:
      "## retrieve\n\n`client.posts.retrieve(postId: string): { post: object; success: boolean; }`\n\n**get** `/v1/posts/{postId}`\n\nGet a single post by ID\n\n### Parameters\n\n- `postId: string`\n\n### Returns\n\n- `{ post: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { content: string; errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }; success: boolean; }`\n\n  - `post: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { content: string; errorMessage: string; platform: string; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; warningMessage: string; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }`\n  - `success: boolean`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst post = await client.posts.retrieve('postId');\n\nconsole.log(post);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ posts: { content: string; createdAt: string; platforms: { platform: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; scheduledFor: string; timezone: string; mediaItems?: { type: 'image' | 'video' | 'gif' | 'document'; url: string; thumbnail?: string; }[]; }[]; success: boolean; total: number; }",
    markdown:
      "## list\n\n`client.posts.scheduled.list(limit?: number, offset?: number, sort?: 'asc' | 'desc'): { posts: object[]; success: boolean; total: number; }`\n\n**get** `/v1/posts/scheduled/`\n\nReturns a paginated list of scheduled posts. Use `limit` + `offset` to page through the results.\n\n### Parameters\n\n- `limit?: number`\n  Page size (max 100)\n\n- `offset?: number`\n  Number of scheduled posts to skip\n\n- `sort?: 'asc' | 'desc'`\n\n### Returns\n\n- `{ posts: { content: string; createdAt: string; platforms: { platform: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; scheduledFor: string; timezone: string; mediaItems?: { type: 'image' | 'video' | 'gif' | 'document'; url: string; thumbnail?: string; }[]; }[]; success: boolean; total: number; }`\n\n  - `posts: { content: string; createdAt: string; platforms: { platform: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; scheduledFor: string; timezone: string; mediaItems?: { type: 'image' | 'video' | 'gif' | 'document'; url: string; thumbnail?: string; }[]; }[]`\n  - `success: boolean`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst scheduleds = await client.posts.scheduled.list();\n\nconsole.log(scheduleds);\n```",
    perLanguage: {
      typescript: {
