...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    "response": "{ url: string; }",
    "markdown": "## get_oauth_url\n\n`client.connect.getOAuthURL(platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky', redirectUri?: string): { url: string; }`\n\n**get** `/v1/connect/{platform}`\n\nGet OAuth URL for a platform\n\n### Parameters\n\n- `platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'`\n\n- `redirectUri?: string`\n  URL to redirect to after a successful connection\n\n### Returns\n\n- `{ url: string; }`\n\n  - `url: string`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst response = await client.connect.getOAuthURL('twitter');\n\nconsole.log(response);\n```",
    "perLanguage": {
      "typescript": {
      ...
      "http": {
        "example": "curl https://api.example.com/v1/connect/$PLATFORM \\\n    -H \"x-access-key: $POSTPEER_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ integrations: { id: string; createdAt: string; displayName: string; imageUrl: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'; platformUserId: string; }[]; success: boolean; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/v1/connect/integrations \\\n    -H \"x-access-key: $POSTPEER_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/v1/connect/integrations/$ID \\\n    -X DELETE \\\n    -H \"x-access-key: $POSTPEER_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ platforms: { name: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'; status: 'prod' | 'beta' | 'dev'; }[]; }",
    "markdown": "## list\n\n`client.platforms.list(): { platforms: object[]; }`\n\n**get** `/v1/platforms`\n\nList available platforms and their status\n\n### Returns\n\n- `{ platforms: { name: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'; status: 'prod' | 'beta' | 'dev'; }[]; }`\n\n  - `platforms: { name: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'; status: 'prod' | 'beta' | 'dev'; }[]`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst platforms = await client.platforms.list();\n\nconsole.log(platforms);\n```",
    "perLanguage": {
      "typescript": {
  ...
  },
  {
    ...
    "description": "Returns a paginated list of posts. Filter by status, platform (OR logic), and date ranges. Published posts include platformPostUrl per platform.",
    ...
    "response": "{ posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]; success: boolean; total: number; }",
    "markdown": "## list\n\n`client.posts.list(createdAfter?: string, createdBefore?: string, limit?: number, offset?: number, platform?: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'[], scheduledAfter?: string, scheduledBefore?: string, sort?: 'asc' | 'desc', status?: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'): { posts: object[]; success: boolean; total: number; }`\n\n**get** `/v1/posts/`\n\nReturns a paginated list of posts. Filter by status, platform (OR logic), and date ranges. Published posts include platformPostUrl per platform.\n\n### Parameters\n\n- `createdAfter?: string`\n  ISO 8601 lower bound on createdAt\n\n- `createdBefore?: string`\n  ISO 8601 upper bound on createdAt\n\n- `limit?: number`\n  Page size (max 100)\n\n- `offset?: number`\n  Number of posts to skip\n\n- `platform?: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'[]`\n  Filter by platform (repeatable — OR logic)\n\n- `scheduledAfter?: string`\n  ISO 8601 lower bound on scheduledFor\n\n- `scheduledBefore?: string`\n  ISO 8601 upper bound on scheduledFor\n\n- `sort?: 'asc' | 'desc'`\n\n- `status?: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'`\n\n### Returns\n\n- `{ posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]; success: boolean; total: number; }`\n\n  - `posts: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }[]`\n  - `success: boolean`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst posts = await client.posts.list();\n\nconsole.log(posts);\n```",
    "perLanguage": {
      "typescript": {
  ...
  },
  {
    ...
    "response": "{ post: { content: string; createdAt: string; crosspostingEnabled: boolean; mediaItems: { filename: string; mimeType: string; size: number; type: 'image' | 'video' | 'gif'; url: string; }[]; platforms: { errorMessage: string; platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'; platformPostId: string; platformPostUrl: string; publishedAt: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; rawRequestBody: object; scheduledFor: string; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; timezone: string; updatedAt: string; }; success: boolean; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/v1/posts/$POST_ID \\\n    -H \"x-access-key: $POSTPEER_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ posts: { content: string; createdAt: string; platforms: { platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; scheduledFor: string; timezone: string; mediaItems?: { type: 'image' | 'video' | 'gif'; url: string; thumbnail?: string; }[]; }[]; success: boolean; }",
    "markdown": "## list\n\n`client.posts.scheduled.list(): { posts: object[]; success: boolean; }`\n\n**get** `/v1/posts/scheduled/`\n\nList all scheduled posts\n\n### Returns\n\n- `{ posts: { content: string; createdAt: string; platforms: { platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; scheduledFor: string; timezone: string; mediaItems?: { type: 'image' | 'video' | 'gif'; url: string; thumbnail?: string; }[]; }[]; success: boolean; }`\n\n  - `posts: { content: string; createdAt: string; platforms: { platform: 'twitter' | 'instagram' | 'youtube' | 'tiktok' | 'pinterest' | 'linkedin' | 'bluesky'; status: 'draft' | 'pending' | 'scheduled' | 'publishing' | 'published' | 'failed' | 'partial'; }[]; postId: string; scheduledFor: string; timezone: string; mediaItems?: { type: 'image' | 'video' | 'gif'; url: string; thumbnail?: string; }[]; }[]`\n  - `success: boolean`\n\n### Example\n\n```typescript\nimport Postpeer from '@postpeer/node';\n\nconst client = new Postpeer();\n\nconst scheduleds = await client.posts.scheduled.list();\n\nconsole.log(scheduleds);\n```",
    "perLanguage": {
      "typescript": {
      ...
      "http": {
        "example": "curl https://api.example.com/v1/posts/scheduled/ \\\n    -H \"x-access-key: $POSTPEER_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/v1/posts/scheduled/$POST_ID \\\n    -X DELETE \\\n    -H \"x-access-key: $POSTPEER_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.example.com/v1/media/upload \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-access-key: $POSTPEER_API_KEY\" \\\n    -d '{\n          \"filename\": \"x\",\n          \"mimeType\": \"x\"\n        }'"
      }
    }
  }
];
